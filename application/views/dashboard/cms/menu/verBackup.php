      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right  accent-danger">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>cms/menu"><i class="fa fa-dashboard"></i> Menu</a></li>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card card-danger">
            ...
            <input type="hidden" name="base_url" id="base_url" value="<?php echo base_url()."menu/"; ?>">
            <form role="form" method="post" action="<?php echo base_url(); ?>cms/menu/actualizar">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-4 <?php echo form_error('nombre') == true ? 'has-error':''?>">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese el nombre del menu" value="<?php echo (set_value('nombre'))?set_value('nombre'):$menu->nombre; ?>" required>
              ...
              <div class="card-footer d-flex">
                <div class="ml-auto btn-group">
                  <a href="<?php echo base_url(); ?>cms/menu" name="btn-atras" id="btn-atras" class="btn bg-gradient-secondary" style="color:white;"><span class="fa fa-backward"> Atrás</span></a>
