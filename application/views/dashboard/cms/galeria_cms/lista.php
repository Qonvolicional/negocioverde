  ...
  <div class="content-wrapper">
   <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Galerias <small class="text-sm">Lista</small></h1>
          </div><!-- /.col -->
         ...
         <div class="col">
            <div class="card">
               <div class="card-header d-flex flex-column flex-md-row">
                  <a class="btn btn-danger"href="<?php echo base_url(); ?>cms_galeria/agregar"><i class="fa fa-plus"></i> Nueva Galeria</a>
                  ...
                  <table id="example1" class="table table-bordered table-striped dataTable responsive" role="grid" aria-describedby="example1_info">
                     ...
                     <tbody>
                        <?php if(!empty($galerias)): ?>
                          ...
                          <?php 
                              $btn_estado = ($galeria->estado)?'btn btn-outline-info':'btn btn-outline-warning';
                            ...
                            <tr>
                              ...
                              <td class="btn-group">
                                <a class="btn btn-outline-primary" href="<?php echo base_url(); ?>cms_galeria/<?php echo $galeria->id;?>"><i class="fas fa-pencil-alt"></i></a>

                                <a class="btn btn-outline-danger btn-eliminar" href="#" data-toggle="modal" data-target="#modalEliminacion" data-href="<?php echo base_url(); ?>cms_galeria/eliminar/<?php echo $galeria->id;?>"><i class="fa fa-trash"></i></a>

                                <a class="<?php echo $btn_estado; ?>" href="<?php echo base_url(); ?>cms_galeria/estado/<?php echo $galeria->id;?>"><i class="<?php echo $span_estado; ?>"></i></a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        <?php endif; ?>
