<div class="content-wrapper">
   <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Producto <small class="text-sm">Lista</small></h1>
          </div><!-- /.col -->
         ...
         <div class="col">
            <div class="card">
               <div class="card-header d-flex flex-column flex-md-row">
                  <a class="btn btn-danger"href="<?php echo base_url().$_SESSION['modulo_string']; ?>/agregar"><i class="fa fa-plus"></i> Nuevo Producto</a>
                  ...
                  <table id="example1" class="table table-bordered table-striped dataTable responsive" role="grid" aria-describedby="example1_info">
                     ...
                     <tbody>
                        <?php if(!empty($productos)): ?>
                          ...
                          <?php 
                              $btn_estado = ($producto->estado)?'btn btn-outline-info':'btn btn-outline-warning';
                              $span_estado = ($producto->estado)?'fa fa-eye':'fa fa-eye-slash';
                            ?>  
                            <tr>
                              <td class="" scope="row">
                              ...
                              <td class="">
                                <?php if(!empty($producto->url_imagen) && file_exists($producto->url_imagen)):?>
                                 <img class="d-flex mx-auto img-fluid img-thumbnail img-responsive" style="max-height: 100px; max-width: 100px" src="<?php echo $producto->url_imagen; ?>" alt="<?php echo $producto->nombre; ?>">
                                 <?php else: ?>
                              ...
                              <td>
                                <?php echo $producto->fecha_modificacion; ?>
                              </td>
                              
                              <td class="btn-group">
                                <a class="btn btn-outline-primary" href="<?php echo base_url().$_SESSION['modulo_string']; ?>/<?php echo $producto->id;?>"><i class="fas fa-pencil-alt"></i></a>

                                <a class="btn btn-outline-danger btn-eliminar" href="#" data-toggle="modal" data-target="#modalEliminacion" data-href="<?php echo base_url().$_SESSION['modulo_string']; ?>/eliminar/<?php echo $producto->id;?>"><i class="fa fa-trash"></i></a>

                                <a class="<?php echo $btn_estado; ?>" href="<?php echo base_url().$_SESSION['modulo_string']; ?>/estado/<?php echo $producto->id;?>"><i class="<?php echo $span_estado; ?>"></i></a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        <?php endif; ?>
