  ...
  <div class="content-wrapper">
   <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Sliders <small class="text-sm">Lista</small></h1>
          </div><!-- /.col -->
         ...
         <div class="col">
            <div class="card">
               <div class="card-header d-flex flex-column flex-md-row">
                  <a class="btn btn-danger"href="<?php echo base_url(); ?>cms_slider/agregar"><i class="fa fa-plus"></i> Nuevo Slider</a>
               ...
               <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped dataTable responsive" role="grid" aria-describedby="example1_info">
                     <thead>
                        <tr>
                          <th cope="col">Título</th>
                          <th cope="col">Vista previa</th>
                          <th cope="col">Fecha de creación</th>
                     ...
                     <tbody>
                       <?php if(!empty($sliders)): ?>
                        <?php foreach ($sliders as $slider ):?>
                          <?php 
                              $btn_estado = ($slider->estado)?'btn btn-outline-info':'btn btn-outline-warning';
                            ...
                            <tr>
                              ...
                              <td class="">
                                <img class="d-flex mx-auto img-fluid img-thumbnail img-responsive" style="max-height: 100px; max-width: 100px" src="<?php echo $slider->url_imagen; ?>" alt="<?php echo $slider->nombre; ?>">
                              </td>
                              ...
                              <td class="btn-group">
                                <a class="btn btn-outline-primary" href="<?php echo base_url(); ?>cms_slider/<?php echo $slider->id;?>"><i class="fas fa-pencil-alt"></i></a>

                                <a class="btn btn-outline-danger btn-eliminar" href="#" data-toggle="modal" data-target="#modalEliminacion" data-href="<?php echo base_url(); ?>cms_slider/eliminar/<?php echo $slider->id;?>"><i class="fa fa-trash"></i></a>

                                <a class="<?php echo $btn_estado; ?>" href="<?php echo base_url(); ?>cms_slider/estado/<?php echo $slider->id;?>"><i class="<?php echo $span_estado; ?>"></i></a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        <?php endif; ?>
