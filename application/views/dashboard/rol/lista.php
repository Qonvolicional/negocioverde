  ...
  <div class="content-wrapper">
   <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Roles <small class="text-sm">Lista</small></h1>
          </div><!-- /.col -->
         ...
         <div class="col">
            <div class="card">
               <div class="card-header d-flex flex-column flex-md-row">
                  <a class="btn btn-danger"href="<?php echo base_url(); ?>rol/agregar"><i class="fa fa-plus"></i> Nuevo Rol</a>
                  ...
                  <table id="example1" class="table table-bordered table-striped dataTable responsive" role="grid" aria-describedby="example1_info">
                     ...
                     <tbody>
                        <?php if(!empty($roles)): ?>
                          ...
                          <?php 
                              $btn_estado = ($rol->estado)?'btn btn-outline-info':'btn btn-outline-warning';
                              $span_estado = ($rol->estado)?'fa fa-eye':'fa fa-eye-slash';
                            ?>  
                            <tr>
                              <td>
                                <?php echo $rol->nombre; ?>
                              ...
                              <td class="btn-group">
                                <a class="btn btn-outline-primary" href="<?php echo base_url(); ?>rol/<?php echo $rol->id;?>"><i class="fas fa-pencil-alt"></i></a>

                                <a class="btn btn-outline-danger btn-eliminar" href="#" data-toggle="modal" data-target="#modalEliminacion" data-href="<?php echo base_url(); ?>rol/eliminar/<?php echo $rol->id;?>"><i class="fa fa-trash"></i></a>

                                <a class="<?php echo $btn_estado; ?>" href="<?php echo base_url(); ?>rol/estado/<?php echo $rol->id;?>"><i class="<?php echo $span_estado; ?>"></i></a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        <?php endif; ?>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title" id="exampleModalLongTitle">Eliminar rol</h3>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <h4>¿Desea continuar con la eliminación del rol?</h4>
        </div>
