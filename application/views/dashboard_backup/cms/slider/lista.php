                  ...
                  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                     <thead>
                        <tr role="row">
                           ...
                           <th style="width: auto;"><p>Acciones</p>
                               <span class="btn btn-social-icon btn-dropbox">
                              ...
                              <span> Eliminar </span>
                              <span class="btn btn-social-icon bg-olive" >
                                    <i class="fa fa-eye-slash"></i>
                                 </span>
                                   <span> No Publicar </span>
                                 <span class="btn btn-social-icon bg-orange">
                                    <i class="fa fa-eye"></i>
                                 </span>  
                                  <span> Publicar </span>
                           </th>
