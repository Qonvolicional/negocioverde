<!-- page header section ending here -->
        ...
        <!-- page header section ending here -->
        <?php if(!is_null($contenido_princial)): ?>
  ...
  border-radius: 4px; margin: 20px;">
                                            <div class="content-part">
                                               <!--div class="entry-header">
                                                    <h3><a href="#"><?php echo $contenido_princial->nombre; ?></a></h3>
                                                </div-->
                                            ...
                                            <div class="tags-section">
                                                ...
                                                <ul class="social-link-list d-flex flex-wrap">
                                                    <li>
                                                        <a href="http://www.facebook.com/share.php?u=<?php echo base_url().$mesa->slugArticulo; ?>&title=<?php echo $mesa->nombre; ?>" class="facebook"><i class="fab fa-facebook-f"></i></a>
                                                    </li>
                                                    <li>
                                                        <a href="https://twitter.com/share?url=<?php echo base_url().$mesa->slugArticulo; ?>&text=<?php echo $mesa->nombre; ?>" class="twitter"><i class="fab fa-twitter"></i></a>
                                                    </li>
                                                    <li>
                                                        <a href="https://plus.google.com/share?url=<?php echo base_url().$mesa->slugArticulo; ?>" class="google"><i class="fab fa-google"></i></a>
                                                    </li>
                                                    <li>
                                                        <a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo base_url().$mesa->slugArticulo; ?>&title=<?php echo $mesa->nombre; ?>" class="linkedin"><i class="fab fa-linkedin-in"></i></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
