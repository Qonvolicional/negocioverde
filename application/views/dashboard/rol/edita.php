...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Rol <small class="text-sm">Editar</small></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right  accent-danger">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>modulo"><i class="fa fa-dashboard"></i> Rol</a></li>
        ...
        <div class="col-12">
          <div class="card card-danger">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-pencil-alt"></i> Edición - <small class="badge badge-primary"><?php echo $rol->nombre; ?></small></h3>
            </div>
            ...
            <?php endif;?>
            <form action="<?php echo base_url();?>rol/actualizar" method="POST">
                <input type="hidden" value="<?php echo $rol->id;?>" name="rol_id">
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-6 <?php echo form_error('nombre') == true ? 'has-error':''?>">
                            <label for="nombre">(*)Nombre</label>
                            <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $rol->nombre; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div >
                                <div class="custom-control custom-switch custom-control-inline">
                                  <input type="checkbox" class="custom-control-input" id="administrador" name="administrador" <?php echo ($rol->administrador)?'checked':''; ?>>
                                  <label class="custom-control-label" for="administrador" >Administrador</label>
                                </div>
                                <div class="custom-control custom-switch custom-control-inline">
                                  <input type="checkbox" class="custom-control-input" id="super" name="super" <?php echo ($rol->super)?'checked':''; ?>>
