<div class="content-wrapper">
   <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Obra <small class="text-sm">Lista</small></h1>
          </div><!-- /.col -->
         ...
         <div class="col">
            <div class="card">
               <div class="card-header d-flex flex-column flex-md-row">
                  <a class="btn btn-danger"href="<?php echo base_url().$_SESSION['modulo_string']; ?>/agregar"><i class="fa fa-plus"></i> Nueva Obra</a>
                  ...
                  <table id="example1" class="table table-bordered table-striped dataTable responsive" role="grid" aria-describedby="example1_info">
                     ...
                     <tbody>
                        <?php if(!empty($obras)): ?>
                          ...
                          <?php 
                              $btn_estado = ($obra->estado)?'btn btn-outline-info':'btn btn-outline-warning';
                              $span_estado = ($obra->estado)?'fa fa-eye':'fa fa-eye-slash';
                            ?>  
                            <tr>
                              <td class="" scope="row">
                               <?php echo $obra->tipo_obra; ?> 
                              </td>
                              ...
                              <td>
                                <?php echo $obra->fecha_modificacion; ?>
                              </td>
                              
                              <td class="btn-group">
                                <a class="btn btn-outline-primary" href="<?php echo base_url().$_SESSION['modulo_string']; ?>/<?php echo $obra->id;?>"><i class="fas fa-pencil-alt"></i></a>

                                <a class="btn btn-outline-danger btn-eliminar" href="#" data-toggle="modal" data-target="#modalEliminacion" data-href="<?php echo base_url().$_SESSION['modulo_string']; ?>/eliminar/<?php echo $obra->id;?>"><i class="fa fa-trash"></i></a>

                                <a class="<?php echo $btn_estado; ?>" href="<?php echo base_url().$_SESSION['modulo_string']; ?>/estado/<?php echo $obra->id;?>"><i class="<?php echo $span_estado; ?>"></i></a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        <?php endif; ?>
