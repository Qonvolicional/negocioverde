          ...
          <div class="box box-success">
            <?php if($_SESSION['rol']!=4): ?>
              <div class="box-header">
                ...
                <a href="<?php echo base_url(); ?>negocioVerde/agregar" class="btn btn-primary btn-social btn-success pull-right"><span class="fa fa-plus"></span> Registrar negocio verde</a>
              </div>
            <?php endif; ?>
            <!-- /.box-header -->
            <div class="box-body">
