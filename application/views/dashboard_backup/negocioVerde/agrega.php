<!--Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php //if(isset($informacionGeneral))var_dump($informacionGeneral); ?>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <div class="progress">
                <div class="progress-bar progress-bar-striped bg-success" id="progresoInscripcion" role="progressbar" style="" aria-valuenow="" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
              <!-- Custom Tabs -->
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                  ...
                  <li class="disabled"><a href="#tab_2" data-toggle="tab">III. Descripción</a></li>
                  <li class="disabled"><a href="#tab_3" data-toggle="tab">IV. Impactos Ambientales y Buenas Prácticas</a></li>
                  <li class="disabled"><a href="#tab_4" data-toggle="tab">V. Características</a></li>
                  
                  <li class="disabled"><a href="#tab_5" data-toggle="tab">Información del verificador y empresario</a></li>
                </ul>
                <!-- /.nav-tabs -->
                <!-- tab-content --> 
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="tab_1">
                    ...
                    <form role="form" method="post" id="almacenarInformacionGeneral" class="form-agregar" enctype="multipart/form-data">
                      ...
                      <div class="box-body">
                        ...
                        <div class="row">
                          <div class="form-group col col-md-4">
                             <input type="hidden" name="representante_legal_id" id="representante_legal_id" class="no"> 
                      ...
                      <div class="box-footer">
                        <div class="form-group alert bg-secondary" role="alert">
                          ...
                          <button type="button" id="verDocumento" class="btn btn-sm btn-success" data-toggle="modal" data-target="#exampleModalLong" >
                      ...
                      <div class="box-footer">
                          <a id="btn-informacion" data-form="almacenarInformacionGeneral" class="btn btn-primary pull-right">Guardar y Continuar <i class="fa fa-arrow-right" aria-hidden="true"></i> </a>
                      </div>
                    </form>
                  </div>
                  <!-- /.tab-pane -->
                  ...
                  <div class="tab-pane" id="tab_3">                
                    <form role="form" id="informacionEmpresa">
                      ...
                      <div class="box-footer">
                        <a id="btn-informacionEmpresa" data-form="informacionEmpresa" class="btn btn-primary pull-right">Guardar y Continuar <i class="fa fa-arrow-right" aria-hidden="true"></i> </a>
                      </div>
                    </form>
                  </div>
                  <!-- /.tab-pane -->
                  <div class="tab-pane" id="tab_4">
                    <form role="form" id="categoriaNegocio">
                      ...
                      <div class="box-footer">
                        <a id="btn-categoria" data-form="categoriaNegocio" class="btn btn-primary pull-right">Guardar y Continuar <i class="fa fa-arrow-right" aria-hidden="true"></i> </a>
                        </div>
                    </form>
                  </div>
                  <!-- /.tab-pane -->
                  ...
                  <div class="tab-pane" id="tab_5">
                    <form role="form" id="informacionVerificacion">
                      ...
                      <?php endif; ?>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col col-md-4">
                              ...
                              <input type="number" name="empresario_identificacion" id="empresario_identificacion" class="form-control empresario" placeholder="Identificación de Empresario" required minlength="7" maxlength="12" unique="empresario">
                              <span class="help-block"></span>
                          </div>
                          <div class="form-group col col-md-4">
                        ...
                        <div class="row">
                          <div class="form-group col col-md-4">
                              <label for="Celular">Celular</label>
                              <input type="number" name="celular" id="celular" class="form-control empresario" placeholder="Número de Contacto del Empresario" minlength="3">
                              <span class="help-block"></span>
                          </div>
                          <div class="form-group col col-md-4">
                              <label for="correo">(*)Correo Electrónico</label>
                              <input type="text" name="empresario_correo" id="empresario_correo" class="form-control empresario" placeholder="Correo Electrónico de Funcionario" required minlength="7" maxlength="100" unique="empresario">
                              <span class="help-block"></span>
                          </div>
                          <div class="form-group col col-md-4">
                      ...
                      <div class="box-header">
                        <a data-form="informacionVerificacion" id="btn-verificadorEmpresario" class="btn btn-primary pull-right">Guardar y Continuar <i class="fa fa-floppy-o" aria-hidden="true"></i> </a>
                      </div>
                    </form>
                  </div>
                  <!-- /.tab-pane -->
                  <div class="tab-pane" id="tab_6">
                    <form role="form" id="observacionGeneral">
                      ...
                      <div class="box-footer">
                        <a href="#"  id="btn-observacion" class="btn btn-primary pull-right" data-form="observacionGeneral"> Guardar y Finalizar <i class="fa fa-arrow-right" aria-hidden="true"></i> </a>
                      </div>
                    </form>
                  </div>
                  <!-- /.tab-pane -->
