...
<div class="content-wrapper">
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>dashboard"><i class="fa fa-dashboard"></i> Administración</a></li>
         <li><a href="<?php echo base_url(); ?>cms/menu">Menu</a></li>
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form role="form" method="post" action="<?php echo base_url(); ?>cms/menu/actualizar">
        <div class="box-body">
           <div class="row">
          ...
          <div class="row desplegableMenu principal">
            ...
            <select class="form-control" id="orden_menu_principal" name="orden_menu_principal" >
                <?php foreach($menuPrincipal as $mp):?>
                  <option value="<?php echo $mp->id;?>" <?php echo ($menu->id==$mp->id)?'selected':''; ?> ><?php echo $mp->nombre;?></option>
                <?php endforeach;?>
            </select>
          </div>
          <div class="row desplegableMenu secundario">
            ...
            <select class="form-control" id="orden_menu_secundaria" name="orden_menu_secundaria" >
                <?php foreach($menuSecundario as $ms):?>
                  <option value="<?php echo $ms->id;?>" <?php echo ($menu->id==$ms->id)?'selected':''; ?> ><?php echo $ms->nombre;?></option>
                <?php endforeach;?>
            </select>
          </div>
                  ...
                  <?php if(!empty($menuContenido2)):?>
                    <?php foreach($menuContenido2 as $mc):?>
                      <tr>
                        ...
                        <td>
                          <span class="btn btn-social-icon btn-dropbox bajar" style="margin-right: 5px;"><i class="fa fa-sort-desc"></i></span>
                          <span class=" btn btn-social-icon btn-google subir" style="margin-right: 5px;"><i class="fa fa-sort-asc"></i></span>
                             <span class="btn btn-info cerrar" ><i class="fa fa-close"></i></span>
                        </td>
                      </tr>
                    <?php endforeach;?>
                  <?php endif;?>
          ...
          <div class="row desplegable contenido">
            <div class="form-group">
              ...
              <input type="text" name="slugArticulo2" id="slugArticulo2" class="form-control" placeholder="Por ejemplo: eventos" value="<?php echo (!(empty($menu->slugArticulo)))?$menu->slugArticulo:'';?>" <?php echo $activacion; ?>>
            </div>
          </div>
