<section class="team-member  padding-tb">
        ...
        <div class="section-wrapper row justify-content-center">
         ...
         <?php foreach ($datos_equipo as $deq): ?>
          <?php 
              ...
              $imagen_perfil = (!file_exists(base_url().$deq->foto)) ? $imagen : base_url().$deq->foto;
           ?>

          <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInUp; margin-bottom: 25px; ">
            <div class=" text-center">
              <div class="post-thumb">
                  <div class="lazy" style="width:200px; height: 200px; 
                  background:url(<?php echo base_url().$deq->foto; ?>); 
                  ...
                  <h4><a href="<?php echo base_url().'referente/perfil/'.$deq->id; ?>" style="cursor: pointer;"><?php echo $deq->nombre; ?></a></h4>
