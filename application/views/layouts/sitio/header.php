...
<html lang="es">
 ...
 <?php if(!empty($noticia)): ?>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/template/css/sitio-style.css">
    ...
    <?php endif; ?>
     ...
     <!--link rel="stylesheet" type="text/css" href="echo base_url(); ?>assets/template/css/font-awesome/css/font-awesome.min.css"-->
