...
<body style="background: url(https://backgroundcheckall.com/wp-content/uploads/2017/12/background-naturaleza-4.jpg);background-size: cover;/* background-position: center; */background-repeat: no-repeat;">
  <div id="login-page" class="row lg" >
    <div class="col s12 z-depth-4 card-panel" style="border: 1px solid #1e7f004d;border-radius: 10px;box-shadow: gray 2px 1px 2px; margin-top:45%;">
