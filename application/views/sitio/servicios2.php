...
<section class="about pt-5">
  <div class="container p-xl-0">
    <div class="section-header section-productos wow fadeInDown" data-wow-duration="1s" data-wow-delay=".1s" style="margin-bottom: 30px!important;">
      ...
      <p style="color: black; margin-bottom: 50px;" class="mt-4"><?php echo $menu->descripcion; ?></p>
        <div class="section-wrapper row justify-content-center">
          ...
          ?>
              <div class="col-xl-6 col-sm-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".<?php echo $delay; ?>s">
                ...
                <div class="lazy post-item-inner text-center producto-item derecha" style="background:url(<?php echo base_url(); ?>/assets/template/img/jch_3.png); background-size: 75px auto;background-repeat: no-repeat;background-position: right bottom; border-radius: 60px 0;">
                  <div class="post-thumb">
                    <img src="<?php echo $imagen_portada; ?>" alt="about">
                  </div>
                  <div class="post-content">
                    <div class="title">
                      <h5 style="color:rgba(233,40,36,1);"><a href="<?php echo base_url()."servicios/leer/".$deq->slug; ?>"><?php echo $deq->nombre; ?></a></h5>
                    </div>
                     <?php if(strlen($deq->descripcion) > 250): ?>
                         <p style="color:black" class="text-justify"><?php echo substr($deq->descripcion, 0, 250) ."... <div class='mx-auto mt-2'><a class='' href='".base_url()."servicios/leer/".$deq->slug."' style='color:rgba(233,40,36,1);'>Ver más</a></div>"; ?></p>

                      <?php else: ?>

                       <p style="color:black" class="text-justify"><?php echo $deq->descripcion; ?>
                         <div class="mx-auto mt-2">
                           <a class="" href="<?php echo base_url()."servicios/leer/".$deq->slug; ?>" style="color:rgba(233,40,36,1);">Ver más</a>
                         </div> 
                       </p>
