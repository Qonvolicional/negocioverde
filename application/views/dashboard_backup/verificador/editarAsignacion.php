            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif;?>
                        <form role="form" action="<?php echo base_url();?>verificador/actualizarAsignacion" method="POST">
                            ...
                            <div class="box-body">
                                ...
                                <?php endif; ?>
                                <input type="hidden" name="asignacion_id" id="asignacion_id" value="<?php echo $asignacion->id;?>">
                                <div class="col-md-12">
                                    <div class="row">
                                            ...
                                            <select class="form-control" id="persona_id" name="persona_id">
                                                ...
                                                <?php if(!empty($verificadores)):?>
                                                    <?php foreach($verificadores as $verificador):?>
                                                        <option value="<?php echo $verificador->persona_id;?>" <?php echo ($verificador->persona_id==$asignacion->persona_id)?'selected':''; ?> ><?php echo $verificador->nombre;?></option>
                                                    <?php endforeach;?>
                                                <?php endif;?>
                                            </select>
                                        </div>
                                            ...
                                            <select class="form-control" id="empresa_id" name="empresa_id">
                                                ...
                                                <?php if(!empty($empresas)):?>
                                                    <?php foreach($empresas as $empresa):?>
                                                        <option value="<?php echo $empresa->id;?>" <?php echo ($empresa->id==$asignacion->empresa_id)?'selected':''; ?> ><?php echo $empresa->nombre;?></option>
                                                    <?php endforeach;?>
                                                <?php endif;?>
                                            </select>
                                        </div>
                                    ...
                                    <!-- <div class="row">
                                        <div class="form-group col col-xs-6">
                                            ...
                                            <input type="date" name="fecha_asignacion" id="fecha_asignacion" class="form-control" value="<?php echo $asignacion->fecha_asignacion; ?>"required> 
                                            <span class="validity"></span>
                                        </div>
                                        <div class="form-group col col-xs-6">
                                            <label for="fecha_retiro">Fecha de retiro</label>
                                            <input type="date" name="fecha_retiro" id="fecha_retiro" class="form-control" required value="<?php echo $asignacion->fecha_retiro; ?>">
                                            <span class="validity"></span>
                                        </div>
                                    </div> -->
