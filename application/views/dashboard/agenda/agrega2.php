...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Agenda <small class="text-sm">Agregar</small></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card card-danger">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-plus"></i> Nueva</h3>
            </div>
            ...
            <form action="<?php echo base_url().$_SESSION['modulo_string']; ?>/almacenar" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-6 <?php echo form_error('fecha') == true ? 'has-error':''?>">
                      <label for="fecha">(*)Fecha de agenda</label>
                        <input type="date" class="form-control" id="fecha" name="fecha" value="<?php echo set_value('fecha'); ?>" required>
                  ...
                  <div class="form-group <?php echo form_error('video') == true ? 'has-error':''?>" >
                      <span class="btn btn-default btn-lg btn-file "><span class="far fa-file-video"> </span>
                          Seleccionar videos/trailer de obra <input type="file" name="video" id="video" class="form-control" accept="video/*">
                      </span>
