  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-<?php echo date("Y");  ?><a href="#">NegociosVerdes</a>.</strong> Todos los derechos reservados.
  </footer>
...
<?php if(!empty($jquery)): ?>
  <?php if(is_array($jquery)): ?>
    <?php foreach ($jquery as $key): ?>
      <script src="<?php echo base_url(); ?><?php echo $key; ?>"></script>  
    <?php endforeach; ?>
  <?php else: ?>
...
<script>
  $(document).ready(function () {
   ...
   /* tinymce.init({ 
      selector:'textarea#descripcion_tt13',
      theme: 'modern',
      height: 200
    });*/
