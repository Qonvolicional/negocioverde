     ...
     <div class="box-body">
           <div class="row">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Ingrese el Nombre del Menu" value="<?php echo $r->titulo; ?>">
                </div>
           </div>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <textarea class="editor form-control" id="contenido" name="contenido" placeholder="Ingrese el contenido"><?php echo $r->cuerpo; ?></textarea>
                </div>
           </div>
