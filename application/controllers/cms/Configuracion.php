...
class Configuracion extends CI_Controller {
	...
	public function index(){
	    ...
	    $data = array('contenidos' => $this->Cms_model->getRegistrosCondifuracion(),);
	    
		$this->load->view("layouts/dashboard/header.php");
		$this->load->view("layouts/dashboard/sidebar.php", $this->moduloControlador);
		$this->load->view("dashboard/cms/configuracion/lista", $data);
	...
	public function editar($id){
		...
		redirect(base_url()."cms/configuracion/");
...
*/
	public function activar($id){
		$this->Cms_model->active('cms_conf_ppal', 'id', $id, 'estado', "'A'");
		redirect(base_url()."cms/configuracion/");
	}
	public function desactivar($id){
		$this->Cms_model->active('cms_conf_ppal', 'id', $id, 'estado', "'I'");
		redirect(base_url()."cms/configuracion/");
	}
