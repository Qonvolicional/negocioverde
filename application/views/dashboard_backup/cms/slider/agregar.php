     ...
     <div class="box-body">
           <div class="row">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingreseun Titulo para el Slider" required="required">
                </div>
           </div>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <textarea class="editor form-control" id="descripcion" name="descripcion" placeholder="Ingrese el contenido" required="required"></textarea>
                </div>
           </div>
