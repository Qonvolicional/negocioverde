<div class="content-wrapper">
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">Gestor de Eventos</li>
      </ol>
   </section>
            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="row col-sm-3 pull-right">
                     <a class="btn btn-block btn-social btn-success col-sm-3" href="<?php echo base_url(); ?>cms/eventos/agregar">
                  ...
                  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                     <thead>
                        <tr role="row">
                           ...
                           <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 90px;">Fecha Evento</th>
                     ...
                     <tbody>
                        ...
                        <tr role="row" class="odd">
                           <td class="sorting_1"><?php echo $contenido->nombreEvento; ?></td>
                           <td class="sorting_1"><?php echo $contenido->estado; ?></td>
                           <td class="sorting_1"><?php echo $contenido->fechaEvento; ?></td>
                           <td class="sorting_1">
                              ...
                              <?php if ($contenido->estado == 'A'): ?>
                                 <a class="btn btn-social-icon bg-olive" href="<?php echo base_url(); ?>cms/eventos/desactivar/<?php echo $contenido->id; ?>">
                                    <i class="fa fa-eye-slash"></i>
                                 </a>
                              <?php else: ?>
                                 <a class="btn btn-social-icon bg-orange" href="<?php echo base_url(); ?>cms/eventos/activar/<?php echo $contenido->id; ?>">
                                    <i class="fa fa-eye"></i>
                                 </a>    
                              <?php endif; ?>
                           </td>
                     ...
                     <tfoot>
                        <tr>
                           ...
                           <th rowspan="1" colspan="1">Fecha Evento</th>
