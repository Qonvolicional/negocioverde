  ...
  > 
    ...
    <div class="container p-md-0">
        <div class="section-wrapper">
            <div class="col-lg-10 sticky-widget" style="border: 1px solid #272624;background: #0c0c0c;box-shadow: #191818 5px 4px 3px;border-radius: 0px;">
            ...
            <div class="col-lg-2 sticky-widget">
