...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Servicio <small class="text-sm"><?php echo $servicio->nombre; ?></small></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right  accent-danger">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url().$_SESSION['modulo_string']; ?>"><i class="fa fa-dashboard"></i> Servicio</a></li>
        ...
        <div class="col-12">
          <div class="card card-danger">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-pencil-alt"></i> Edición - <small class="badge badge-primary"><?php echo $servicio->nombre; ?></small></h3>
            </div>
            ...
            <form action="<?php echo base_url().$_SESSION['modulo_string']; ?>/actualizar" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group <?php echo form_error('nombre') == true ? 'has-error':''?>">
                      ...
                      <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo (form_error('nombre'))?set_value('nombre'):$servicio->nombre; ?>">
                      <?php echo form_error("nombre","<span class='help-block'>","</span>");?>
                  </div>
                  <div class="form-group <?php echo form_error('descripcion') == true ? 'has-error':''?>">
                      <label for="descripcion">(*)Descripcion</label>
                      <textarea name="descripcion" id="descripcion" class="form-control descripcion"><?php echo set_value('descripcion'); ?><?php echo $servicio->descripcion; ?></textarea>
                  ...
                  <div class="form-group <?php echo form_error('imagen') == true ? 'has-error':''?>">
                      ...
                      <div class="row" id="previsualizacion" style="margin:5px;">
                          <?php if(!empty($servicio->url_imagen)):?>
                              <div class="col-sm-4">
                                  <p>Nombre de archivo: <small><?php echo explode("assets/archivo/",base_url().$servicio->url_imagen)[1]; ?></small></p>
                                  <img src="<?php echo base_url().$servicio->url_imagen; ?>" alt="<?php echo $servicio->nombre; ?>" class="img-fluid img-thumbnail img-responsive">
                              </div>
                          <?php else: ?>
                              <div class="col-sm-4">
