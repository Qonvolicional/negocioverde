                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>cms_publicacion/almacenar" method="POST" enctype="multipart/form-data">
                                ...
                                <select class="form-control" name="cms_tipo_publicacion_id" id="cms_tipo_publicacion_id">
                                    <?php if(!empty($tipo_publicacion)):?>
                                        ...
                                        <?php foreach($tipo_publicacion as $tipo ): ?>
                                            <option value="<?php echo $tipo->id; ?>" <?php echo (set_value('cms_tipo_publicacion_id')==$tipo->id)?'selected':''; ?> > <?php echo $tipo->nombre; ?></option>
                                        <?php endforeach; ?>
                                    <?php endif;?>
                                </select>
                            ...
                            <div class="row desplegable convocatoria evento">
                                <div class="form-group col-md-6 convocatoria evento">
                                    <label for="fecha_apertura">Fecha de apertura:</label>
                                    <input type="date" name="fecha_apertura" id="fecha_apertura" class="form-control">
                                </div>
                                <div class="form-group col-md-6 convocatoria">
                            ...
                            <div class="form-group desplegable convocatoria evento <?php echo form_error('documento') == true ? 'has-error':''?>">
