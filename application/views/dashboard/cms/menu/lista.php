         ...
         <div class="col">
            <div class="card">
               <div class="card-header d-flex flex-column flex-md-row">
                  <a class="btn btn-danger"href="<?php echo base_url().$_SESSION['modulo_string']; ?>/agregar"></i> Nuevo Menu</a>
                        ...
                        <?php if(!empty($menus)): ?>
                           <?php foreach ($menus as $menu ):?>
                              ...
                              <tr>
                                 ...
                                 <td class="btn-group">
                                    <a class="btn btn-outline-primary" href="<?php echo base_url().$_SESSION['modulo_string']; ?>/<?php echo $menu->id; ?>"><i class="fas fa-pencil-alt"></i></a>

                                    <a class="btn btn-outline-danger" href="<?php echo base_url().$_SESSION['modulo_string']; ?>/eliminar/<?php echo $menu->id; ?>"><i class="fa fa-trash"></i></a>

                                    <a class="<?php echo $btn_estado; ?>" href="<?php echo base_url().$_SESSION['modulo_string']; ?>/estado/<?php echo $menu->id; ?>"><i class="<?php echo $span_estado; ?>"></i></a>
                                 </td>
                              </tr>
                           <?php endforeach; ?>
                        <?php endif; ?>
