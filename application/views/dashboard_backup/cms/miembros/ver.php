        ...
        <div class="box-body">
           <div class="row">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingreseun Titulo para el Slider" value="<?php echo $r->nombre; ?>" required="required">
                </div>
           </div>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <textarea class="editor form-control" id="descripcion" name="descripcion" placeholder="Ingrese el contenido" required="required"><?php echo $r->descripcion; ?></textarea>
                </div>
           </div>
           ...
           <div class="row">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Url" name="Url" placeholder="http://ejemplopaginaweb.com" value="<?php echo $r->Url; ?>" required="required">
                </div>
           </div>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <select multiple class="form-control" name="statusSlider" id="statusSlider" required="required">
                        <?php  
                        if ($r->statusSlider == 'A'):
                        ?>
