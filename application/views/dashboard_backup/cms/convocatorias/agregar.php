     ...
     <div class="box-body">
           <div class="row">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Ingrese el Título de la Convocatoria" required="required">
                </div>
           </div>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <textarea class="editor form-control" id="contenido" name="contenido" placeholder="Ingrese la Descripción de la COnvocatoria" required="required"></textarea>
                </div>
           </div>
